...
PACKAGES=(soryos-archive-keyring sory-shell sory-theme sory-settings sory-installer)
...
printf 'Rollback: sudo rm -f %s %s && sudo apt update\n' "$SOURCE_PATH" "$KEYRING_PATH"
